...
<template>
    <div class="see-more">
        <div class="see-more__container">
            ...
            <div class="see-more__status" v-if="pending">Ожидание ответа от сервера...</div>
            <div class="see-more__status see-more__status--error" v-else-if="error">Произошла ошибка</div>
            <div class="see-more__grid" v-else-if="projects">
                <ProjectCard :project="projects[0]" v-if="projects[0]"/>
                <ProjectCard :project="projects[1]" v-if="projects[1]"/>
            </div>
